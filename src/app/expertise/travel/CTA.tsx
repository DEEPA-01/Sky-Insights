...
export default function TravelCTAForm() {
  ...
  // ⭐ Handle Submit — CONNECTED WITH DATABASE
    ...
    try {
      const res = await fetch("/api/messages", {
        ...
        body: JSON.stringify({
          ...
          message: `Travel Business Inquiry:\n${formData.message}`,
          page: "/travel-marketing",
        }),
      });
    ...
    <section className="-mt-16 bg-white py-16 px-6 md:px-12 flex flex-col justify-center items-center">
      ...
      <div className="text-center mb-6">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 leading-snug">
          Grow Your <span className="text-blue-600">Travel Business</span> With
          Digital Marketing
        </h2>
        ...
        <p className="text-gray-700 text-base md:text-lg mt-3 max-w-2xl mx-auto leading-relaxed">
          ...
          help you attract more travelers, boost inquiries, and increase
          bookings with smart travel-focused digital marketing.
        </p>
      </div>

      {/* ⭐ Social Icons (MOVED UPWARD) */}
          ...
          >
            ...
            <div className="relative w-full">
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={3}
                placeholder="Tell us about your travel business or services"
                required
